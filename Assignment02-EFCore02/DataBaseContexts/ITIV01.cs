using Assignment01_EFCore01.ModelConfigurations;
...
namespace Assignment01_EFCore01.DataBaseContexts
{
    internal class ITIV01 : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server = .; DataBase = ITIV02; Trusted_Connection = true ;TrustServerCertificate = true");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new InstructorCnfigurations());
